...
def card6():
    ...
    if question.lower() == "no":
        ...
        print("Sire this is urgent for our religious population, please make a choice!")
        card6()
...
def card7():
    ...
    if question.lower() == "yes":
        ...
        print("Please refrain from saying such things")
        card7()
...
def card9():
    ...
    if question.lower() == "yes":
        ...
        print("Could you repeat that again? A Yes or No would make it easier for me to understand") 
        card9()
...
def card10():
    ...
    if tools.vssltroops == True:
        ...
        if question.lower() == "yes":
            ...
            print("Forgive me, but what did you say my lord?") 
            card10()
...
def card14():
    ...
    if tools.vssltroops == True:
        ...
        if question.lower() == "yes":
            ...
            print("Now is not the time for games my lord! Lives depend on this!")
            card14()
    else:
        pass
...
def death_parameters():
    ...
    if army > 80:
        ...
        dead = True
        print("Your governors become too corrupt to run anything for you")
    elif pops > 80:
        dead = True
    ...
    if cash < 1:
        if tools.vault == True:
            ...
            dead = True
            print("You died penniless on the streets of the kingdom you once ruled1")
